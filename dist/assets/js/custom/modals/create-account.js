	...
	return{
		init:function(){(
			...
			(r=new KTStepper(t)).on("kt.stepper.changed",(function(e){
				13===r.getCurrentStepIndex()?(o.classList.remove("d-none"),
				o.classList.add("d-inline-block"),
				s.classList.add("d-none")):14===r.getCurrentStepIndex()?(o.classList.add("d-none"),
				s.classList.add("d-none")):(o.classList.remove("d-inline-block"),
				o.classList.remove("d-none"),s.classList.remove("d-none"))})),
					...
					t?t.validate().then((function(t){
						...
						Swal.fire({
							...
							.then((function(){
								...
								(function(e){console.log("stepper.previous"),
								e.goPrevious(),
								KTUtil.scrollTop()})),
								a.push(FormValidation.formValidation(i,{
									...
									account_name2:{validators:{notEmpty:{message:"Account name is required"}}},
																					...
																					,business_description:{
																						validators:{
																							notEmpty:{
																								...
																								business_email:{validators:{notEmpty:{
